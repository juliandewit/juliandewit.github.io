...
|Description|Quantity|Weight|Model|
|---|--:|--:|--:|
...
|NDSB positives, negatives|1400|20|only 2|
...
I used a specia, hastily built, viewer to debug all the labels. Below are some screenshot I took.
