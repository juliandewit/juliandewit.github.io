...
*Figure 4. Large nodule detection at 1x and 2x zoom. Size of the rectangles indicated estimated malignancy*	
...
In the end from my point of view joining forces was a very good decision. While I was heavily frustrated with the leaderboard Daniel was quite confident that we should mainly focus on local CV. So in the end I reduced the effort in matching local CV with LB and focussed on improving the local CV a bit more. On the final leaderboard this turned out to be a good decision since the final stage2 leaderboard matched quite well with local CV and we ended up second while many teams with better stage 1 leaderboard scores turned out to have been overfitting.
...
Malignancy labeling of the NDSB dataset.
Try out more neural network architectures.
...
2. *Authors of Keras and TensorFlow.* The windows release of TensorFlow came just at the right time for me. The Keras API was very easy to use.

3. *Daniel Hammack.* <br> The idea was great. The paper was easy to understand with clear language and concrete examples. That is something you do not find everyday in the deep learning community.
